...
// Model 由于gorm提供的base model没有json tag, 使用自定义
type Model struct {
...
func (t *LocalTime) UnmarshalJSON(data []byte) (err error) {
	...
	// ""空值不进行解析
	// 避免环包调用, 不再调用utils
	if str == NullString || strings.TrimSpace(str) == "" {
