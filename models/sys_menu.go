...
type SysMenu struct {
	...
	OnlyContent *uint      `gorm:"type:tinyint(1);default:0;comment:'是否只渲染内容布局'" json:"OnlyContent"`
	NewTab      *uint      `gorm:"type:tinyint(1);default:0;comment:'是否打开新标签页'" json:"NewTab"`
